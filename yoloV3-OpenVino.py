...
# anchors = [10,13,16,30,33,23,30,61,62,45,59,119,116,90,156,198,373,326] #<------ YoloV3
anchors = [10,14, 23,27, 37,58, 81,82, 135,169, 344,319] 				#<-------YoloV3-tiny
...
def main_IE_infer():
    ...
    # model_xml = "yoloV3-OpenVino/yoloV3/frozen_darknet_yolov3_model.xml" #<--- YOLO-V3
    model_xml = "yoloV3-OpenVino/yoloV3-tiny/frozen_darknet_yolov3_model.xml" #<--- YOLO-V3-tiny
